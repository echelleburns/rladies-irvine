...
widescreen: true
theme: default
logo: /Users/echel/Downloads/rladies.jpeg
---
...
<center>
<img src="presentation-images/latitude-longitude-lines.jpg" height=200>
</center>
...
- tracking animals: where do they go? how do they interact with their environment? (__today__)
...
- predicting the next earth quake from previous earth quake locations
...
<center>
<img src="presentation-images/PLEVER.tif" height=100>
<img src="presentation-images/SEBMIN.tif" height=100>
<img src="presentation-images/PARVET.tif" height=100>
</center>
...
- a shapefile with wastewater outfall location
- a shapefile with water depths (bathymetry)
- a shapefile with US states (land masses)
...
random_sample <- fish_locations[sample(nrow(fish_locations), 10), ]
...
- but it gets pretty tricky when you're trying to add your own shapefiles

<center><img src="presentation-images/data-minds.jpeg" height=350></center>
